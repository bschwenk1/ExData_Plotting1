#Create plot: graph of Global active power
#This code creates graph of global active power on 1 and 2 of february 2007 per minute
...
if (!file.exists("household_power_consumption.txt")){
  ...
  unzip("household_power_consumption.zip",exdir=getwd())   # extracted file is: household_power_consumption.txt
